...
public class TekstkyklopTest {
    ...
    //@Test
    public void fjernFoersteDelAvStrengMedDelimiterTest(){
        String testverdiString = "Dette, er en enkel test.";
        String forventetString = "er en enkel test.";
        String utregnetString = TekstKyklop.hent().fjernFoersteDelAvStrengMedDelimiter(testverdiString,"\\ ");
        TestMester.logOgAssertString(testverdiString,forventetString,utregnetString);
    }

    //@Test
    public void fjernSisteDelAvStrengMedDelimiterTest(){
        String testverdiString = "Dette, er en enkel test, dette";
        String forventetString = "Dette, er en enkel test,";
        String utregnetString = TekstKyklop.hent().fjernSisteDelAvStrengMedDelimiter(testverdiString,"\\ ");
        TestMester.logOgAssertString(testverdiString,forventetString,utregnetString);
    }
